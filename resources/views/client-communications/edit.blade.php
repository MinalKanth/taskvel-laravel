...
@section('title', 'Edit Client Communication')
...
<div class="container-fluid">
    ...
    <form
        action="{{ route('client-communications.update', $clientCommunication) }}"
        method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select
                            ...
                            @foreach($clients as $client)
                                ...
                                <option
                                    value="{{ $client->id }}"
                                    @selected(old('client_id', $clientCommunication->client_id) == $client->id)>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select
                            ...
                            @foreach($users as $user)
                                ...
                                <option
                                    value="{{ $user->id }}"
                                    @selected(old('user_id', $clientCommunication->user_id) == $user->id)>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select
                            ...
                            @foreach([
                                ...
                                <option
                                    value="{{ $channel }}"
                                    @selected(old('channel', $clientCommunication->channel) == $channel)>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select
                            ...
                            <option
                                value="Incoming"
                                @selected(old('direction', $clientCommunication->direction) == 'Incoming')>
                            ...
                            <option
                                value="Outgoing"
                                @selected(old('direction', $clientCommunication->direction) == 'Outgoing')>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('subject', $clientCommunication->subject) }}"
                            maxlength="255"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea
                            ...
                            required>{{ old('message', $clientCommunication->message) }}</textarea>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('sender_name', $clientCommunication->sender_name) }}"
                            maxlength="255"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('sender_email', $clientCommunication->sender_email) }}"
                            maxlength="255"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('sender_phone', $clientCommunication->sender_phone) }}"
                            maxlength="20"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('receiver_name', $clientCommunication->receiver_name) }}"
                            maxlength="255"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('receiver_email', $clientCommunication->receiver_email) }}"
                            maxlength="255"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('receiver_phone', $clientCommunication->receiver_phone) }}"
                            maxlength="20"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('thread_id', $clientCommunication->thread_id) }}"
                            maxlength="255"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('message_id', $clientCommunication->message_id) }}"
                            maxlength="255"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('communication_at', optional($clientCommunication->communication_at)->format('Y-m-d\TH:i')) }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select
                            ...
                            @foreach([
                                ...
                                <option
                                    value="{{ $status }}"
                                    @selected(old('status', $clientCommunication->status) == $status)>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <input
                                ...
                                name="has_attachment"
                                value="1"
                                @checked(old('has_attachment', $clientCommunication->has_attachment))>
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <textarea
                            ...
                            placeholder='{"key":"value"}'>{{ old('metadata', is_array($clientCommunication->metadata) ? json_encode($clientCommunication->metadata, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : $clientCommunication->metadata) }}</textarea>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <a
                        href="{{ route('client-communications.show', $clientCommunication) }}"
                    ...
                    <button
                        ...
                        <i class="mdi mdi-content-save-edit me-1"></i>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    messageField.addEventListener(
        ...
        /*
    |--------------------------------------------------------------------------
    | Ensure Communication Date Has Value
    |--------------------------------------------------------------------------
    */
