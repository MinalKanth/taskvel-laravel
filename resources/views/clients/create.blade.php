                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select
                            ...
                            <option value="Proprietorship" @selected(old('constitution')=='Proprietorship')>
                                Proprietorship
                            </option>

                            <option value="Partnership" @selected(old('constitution')=='Partnership')>
                                Partnership
                            </option>

                            <option value="LLP" @selected(old('constitution')=='LLP')>
                                LLP
                            </option>

                            <option value="Private Limited" @selected(old('constitution')=='Private Limited')>
                                Private Limited
                            </option>

                            <option value="Public Limited" @selected(old('constitution')=='Public Limited')>
                                Public Limited
                            </option>

                            <option value="Trust" @selected(old('constitution')=='Trust')>
                                Trust
                            </option>

                            <option value="Society" @selected(old('constitution')=='Society')>
                                Society
                            </option>

                            <option value="NGO" @selected(old('constitution')=='NGO')>
                                NGO
                            </option>

                            <option value="Other" @selected(old('constitution')=='Other')>
                                Other
                            </option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select
                            ...
                            <option value="Lead" @selected(old('status')=='Lead')>
                                Lead
                            </option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea
                            ...
                            placeholder="Enter any additional information about the client...">{{ old('notes') }}</textarea>
