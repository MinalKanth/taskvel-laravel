...
@section('title', 'Add Client Remark')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                Record a remark, follow-up, meeting note, compliance note, or client communication.
    ...
    <form
        action="{{ route('client-remarks.store') }}"
        method="POST"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select
                            ...
                            @foreach($users as $user)
                                ...
                                <option
                                    value="{{ $user->id }}"
                                    @selected(old('mentioned_user_id') == $user->id)>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea
                            ...
                            placeholder="Write your remark here...">{{ old('remark') }}</textarea>
