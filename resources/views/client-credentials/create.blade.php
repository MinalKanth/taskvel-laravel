...
@section('title', 'Create Client Credential')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                Store portal login credentials and authentication details securely.
    ...
    <form
        action="{{ route('client-credentials.store') }}"
        method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            placeholder="GSTIN / PAN / TAN / Registration No.">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('last_password_changed_at') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('dsc_serial_number') }}"
                            placeholder="DSC Serial Number">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea
                            ...
                            placeholder="Additional notes about this credential...">{{ old('remarks') }}</textarea>
