...
class UpdateClientContactRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'whatsapp_number.digits' => 'WhatsApp number must contain exactly 10 digits.',
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'alternate_mobile' => $this->alternate_mobile
                ? preg_replace('/\D/', '', (string) $this->alternate_mobile)
                : null,

            'whatsapp_number' => $this->whatsapp_number
                ? preg_replace('/\D/', '', (string) $this->whatsapp_number)
                : null,
