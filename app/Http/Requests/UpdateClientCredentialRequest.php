...
class UpdateClientCredentialRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        $credentialId = $this->route('credential')?->id
            ?? $this->route('clientCredential')?->id
            ?? $this->route('client_credential');
    ...
    public function messages(): array
    {
        return [
            ...
            'client_id.unique' => 'This portal already exists for the selected client.',
